...
public class SmartphoneService implements ISmartphoneService {
    ...
    @Override
    public Iterable<Smartphone> findAllByProducerContainingIgnoreCase(String producer) {
        return iSmartphoneRepository.findAllByProducerContainingIgnoreCase(producer);
    }
}
